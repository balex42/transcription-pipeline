...
from meeting_transcriber.errors import ModelLoadError, VoxtralStreamingError, VoxtralTimestampError
...
class VoxtralStreamingState:
    """Per-meeting transport bookkeeping; native generate owns all model caches."""
...
class VoxtralTranscriber(Transcriber):
    """Use Voxtral's single native streaming generation session for a whole meeting."""
