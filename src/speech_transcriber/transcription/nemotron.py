...
from speech_transcriber.errors import ASROutputError, ModelLoadError, NemotronStreamingError
...
class NemotronStreamingState:
    """Per-recording streaming bookkeeping; native generate owns model caches."""
...
class NemotronTranscriber(Transcriber):
    """Use native RNNT generator streaming for one continuous recording timeline."""
